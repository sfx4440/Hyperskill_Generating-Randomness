    ...
    def check(self, output: str, attach) -> CheckResult:
        ...
        for iter in range(game_iterations):
            ...
            if '(' not in result or ')' not in result:
                return CheckResult.wrong("The line of output after prediction in each game iteration is supposed "
            ...
            try:
                ...
                if output_cap != cap:
                    return CheckResult.wrong(
                        "The string \"{}\" of your output is supposed to contain the information about user balance. \n"
                        "However, its value does not coincide with the expected one.\n"
                        "Don't forget to exclude the first 3 symbols from the calculation of balance".format(balance_info)
                    )
            except ValueError:
                return CheckResult.wrong(
                    "The string \"{}\" of your output is supposed to contain the information about user balance. \n"
